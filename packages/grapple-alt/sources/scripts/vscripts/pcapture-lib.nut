...
+----------------------------------------------------------------------------------+ */
// MODIFIED BY RIP RIP RIP FOR GRAPPLE GUN MOD
...
::defaultSettings <- {  
    ...
    "trigger_", "phys_", "env_", "point_", "vgui_", "info_lighting", "info_placement_helper" "info_lighting_relative" "func_door", "func_door_rotating" "physicsclonearea", "func_breakable", "player_pickup", "paint_sphere", "func_portal_bumper", "prop_dynamic", "prop_testchamber_door", "prop_floor_button", "prop_under_floor_button", "func_movelinear", "prop_portal", "func_noportal_volume", "func_clip_vphysics", "func_portal_detector", "func_areaportal", "func_areaportalwindow", "color_correction", "func_brush", "logic_", "move_rope", "keyframe_rope", "path_", "func_tracktrain", "fizzler_multiorigin_sound_player", "ambient_generic", "ai_script_conditions"),
    priorityClass = arrayLib.new("linked_portal_door", "npc_wheatley_boss"),
    customFilter = null,      
